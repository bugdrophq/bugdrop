...
[GitHub Release](https://github.com/bugdrophq/bugdrop/releases) for canonical notes and assets.
...
- [View GitHub Releases](https://github.com/bugdrophq/bugdrop/releases) for canonical release history
