...
**[SELF_HOSTING.md on GitHub](https://github.com/bugdrophq/bugdrop/blob/main/SELF_HOSTING.md)**
...
See the
**[production heartbeat runbook](https://github.com/bugdrophq/bugdrop/blob/main/docs/production-heartbeat.md#self-hosted-and-private-repositories)**
...
git remote add upstream https://github.com/bugdrophq/bugdrop.git
...
Check the [CHANGELOG](https://github.com/bugdrophq/bugdrop/blob/main/CHANGELOG.md) before updating to review any breaking changes or new configuration options.
...
- Open an issue on the [GitHub repository](https://github.com/bugdrophq/bugdrop/issues)
- Review the [Security](/docs/security) page for permission and rate limiting details

## Next Steps

- [Read the full self-hosting guide](https://github.com/bugdrophq/bugdrop/blob/main/SELF_HOSTING.md)
