...
the [Privacy Policy](https://github.com/bugdrophq/bugdrop/blob/main/PRIVACY.md) for the
...
- **Preferred:** use [GitHub private vulnerability reporting](https://github.com/bugdrophq/bugdrop/security/advisories/new)
...
See the canonical [BugDrop security policy](https://github.com/bugdrophq/bugdrop/security/policy)
